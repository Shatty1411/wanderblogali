    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h2>Location </h2>
                <br> <br>
				                    <img class="img-responsive img-hover" src="pictures/placeholder.jpg" alt="">

				<br> <br>
				<hr>

				<p>Arabs migrated to Oman from the 9th century BC onward, and conversion to Islam occurred in the 7th century AD Muscat, the capital of the geographical area known as Oman, was occupied by the Portuguese from 1508 to 1648. Then it fell to Ottoman Turks, but in 1741, Ahmad ibn Sa'id forced them out, and the descendants of Sultan Ahmad rule Oman today.
...
<br>
				<div class="media">
                    <a class="pull-left" href="#">
                        <img class="media-object" src="pictures/com.png" alt="">
                    </a>
